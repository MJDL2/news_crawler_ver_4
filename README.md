...
- ⚙️ 통합 설정 파일 시스템 (v4.2.6)
- 🔄 개선된 날짜별 수집 및 병합 기능 (v4.2)
- 🧹 코드 품질 개선 및 표준화 (v4.2.7)
- ✨ Phase 1 개발 완료: 안정화된 크롤링 시스템 (v4.2.7)
...
- 📖 [사용자 가이드](docs/USER_GUIDE.md) - 상세한 사용 방법 (v4.2.7)
- 🏗️ [아키텍처 문서](docs/ARCHITECTURE.md) - 프로젝트 구조 및 설계
- 💻 [개발 가이드](docs/DEVELOPMENT.md) - 개발 및 기여 방법
- 📝 [변경 이력](docs/CHANGELOG.md) - 버전별 변경사항
- 📊 [진행 상황](docs/PROGRESS.md) - 현재 개발 상태 및 계획 (v4.2.7)
- 🗺️ [개발 로드맵](DEVELOPMENT_ROADMAP.md) - 장기 계획 및 Phase 진행상황
...
### 403 Forbidden 오류 (v4.2.7 안정화)
네이버가 봇을 감지하여 차단하는 경우:
- **자동 대응**: 세션 풀 관리로 차단된 세션 자동 교체 (v4.2.x에서 안정화)
...
- 네이버 서비스 이용약관을 준수하세요
- v4.2.7부터 안정화된 403 오류 대응 기능이 제공되나, 적절한 사용을 권장합니다
...
- **v4.2.7 (2025-06-07)**: 🎉 Phase 1 완료 - 코드 품질 개선 및 표준화, 문서 업데이트
- **v4.2.6 (2025-06-04)**: 설정 파일 통합 완료 (3개 → 1개), 코드 복잡도 감소
- **v4.2.5 (2025-06-04)**: 미사용 import 정리, PEP 8 스타일 적용
